...
class fbauthorize{
    ...
    const IMG_PATH = 'media/stilerospfacebookgroup/assets/images/';
    const JS_PATH = 'media/stilerospfacebookgroup/assets/js/';
    const CATCHER_URI = 'plugins/socialpromoter/stilerospfacebookgroup/helpers/catcherJ16.php';
    const HELPERS_URI = 'plugins/socialpromoter/stilerospfacebookgroup/helpers/';
